...
function Footer() {
  return (
   ...
   <div style={{height:'300px',backgroundColor:"black"}}  className='mt-5 w-100'>
       ...
       <p className='text-center mt-5'>Copyright &copy; 2024 ProjectFair.Bulid with React</p>
        </div>
   </>
  )
}
